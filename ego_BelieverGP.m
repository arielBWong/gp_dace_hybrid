function[match_xl, n_fev, flag] = ego_BelieverGP(xu, prob, seed)
...
[match_xl, n_fev, flag] = post_infillsaveprocess(xu, train_xl, train_fl, train_fc, 'llble_gp', seed, prob, init_size);
save_eachmodel(seed, 'llble_gp', mdl_save, init_size, prob);
end
